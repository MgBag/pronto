...
namespace pronto
{
  namespace graphics
  {
    ...
    void StateObject::InitTexture()
    {
      ...
      root_signature_description_[(int)PrimitiveType::kTexture].Init_1_1(
        root_param_count,
        root_parameters,
        1,
        &sampler,
      ...
      HRESULT hr = D3DX12SerializeVersionedRootSignature(
        &root_signature_description_[(int)PrimitiveType::kTexture],
      ...
      root_signature_[(int)PrimitiveType::kTexture] = root_sig;
      ...
      pso_[(int)PrimitiveType::kTexture] = pso;

      is_init_[(int)PrimitiveType::kTexture] = true;
    }
  }
}