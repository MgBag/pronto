...
namespace pronto
{
  namespace graphics
  {
    ...
    void StateObject::InitColor()
    {
      ...
      // Material color
      root_parameters[3].InitAsConstants(
        sizeof(glm::vec4) / 4,
        3,
        D3D12_ROOT_DESCRIPTOR_FLAG_NONE,
        D3D12_SHADER_VISIBILITY_ALL);
      ...
      root_signature_description_[(int)PrimitiveType::kColor].Init_1_1(
        root_param_count,
        root_parameters,
        0,
        nullptr,
      ...
      HRESULT hr = D3DX12SerializeVersionedRootSignature(
        &root_signature_description_[(int)PrimitiveType::kColor],
      ...
      root_signature_[(int)PrimitiveType::kColor] = root_sig;
      ...
      rast_desc.CullMode = D3D12_CULL_MODE_BACK; //NONE
      ...
      auto vertex_shader = Resource::Get()->LoadShader(
        "resource/shaders/color/vertex.hlsl",
      ...
      auto pixel_shader = Resource::Get()->LoadShader(
        "resource/shaders/color/pixel.hlsl",
      ...
      pso_[(int)PrimitiveType::kColor] = pso;

      is_init_[(int)PrimitiveType::kColor] = true;
